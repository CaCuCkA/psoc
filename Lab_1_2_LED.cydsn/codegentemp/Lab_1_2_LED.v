...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8beb4fcc-24bd-421a-8046-e2d6b740f7c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 RES_B (
        .connect({
            Net_424,
            Net_432
        })
    );
    defparam RES_B.comp_name = "Resistor_v1_0";
    defparam RES_B.port_names = "T1, T2";
    defparam RES_B.width = 2;

    cy_annotation_universal_v1_0 RES_R (
        .connect({
            Net_426,
            Net_430
        })
    );
    defparam RES_R.comp_name = "Resistor_v1_0";
    defparam RES_R.port_names = "T1, T2";
    defparam RES_R.width = 2;
