// ======================================================================
// Lab_3_2_UART_Led.v generated from TopDesign.cysch
// 12/04/2022 at 03:06
...
module SPI_Master_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("050699e7-e588-4f60-8fb3-11f2b495ee60/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
...
module top ;
    ...
    assign Net_49 = ~Net_46;

    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_213)
    begin
        cydff_1 <= Net_49;
    end
    assign Net_46 = cydff_1;
    // -- DFF End --
	...
	cy_psoc3_pins_v1_10
		#(.id("b685623b-0335-4ddd-a894-a7a7ec1faa22"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("55c4ed6d-a093-4375-9fb7-4fb9c842f233"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_0 SPIM (
        ...
        .clock(1'b0),
        .reset(Net_209),
        .rx_interrupt(Net_210),
        .sdat(Net_211),
        .tx_interrupt(Net_212));
	...
	cy_psoc3_pins_v1_10
		#(.id("a486b2e0-798e-4ade-9625-9973013e382d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f3b8305f-eb47-44e1-9088-8e90efca719b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("efbf377f-dfc7-4d2b-bff0-292071e5b304"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("813590ef-a8ac-47e0-be27-cd239a975b4b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
